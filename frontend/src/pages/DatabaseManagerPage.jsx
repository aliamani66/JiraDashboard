...
import { Database, Search, Play, RefreshCw, Layers, CheckCircle2, AlertTriangle, Table, FileText, ChevronLeft, ChevronRight, Copy, Terminal, Lock, ShieldAlert, X } from 'lucide-react';
      ...
      <AnimatePresence>
        {toast && (
          <div style={{
            ...
            <motion.div
              ...
              style={{
                ...
                boxShadow: toast.type === 'error'
                  ? '0 20px 45px rgba(0, 0, 0, 0.6), 0 0 30px rgba(239, 68, 68, 0.35)'
                  : '0 20px 45px rgba(0, 0, 0, 0.6), 0 0 30px rgba(16, 185, 129, 0.35)',
                color: '#FFFFFF',
                fontSize: '0.92rem',
                fontWeight: 700,
                maxWidth: '680px',
            ...
            >
              {toast.type === 'error' ? (
                <ShieldAlert size={22} color="#FFFFFF" style={{ flexShrink: 0 }} />
              ) : toast.type === 'warning' ? (

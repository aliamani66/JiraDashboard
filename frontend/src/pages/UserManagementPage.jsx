      ...
      <AnimatePresence>
        {toast.show && (
          <div style={{
            ...
            >
              {toast.type === 'success' ? <CheckCircle2 size={22} color="#FFFFFF" style={{ flexShrink: 0 }} /> : <AlertCircle size={22} color="#FFFFFF" style={{ flexShrink: 0 }} />}
              <span style={{ lineHeight: 1.5, flex: 1 }}>{toast.message}</span>
              <button
                type="button"
